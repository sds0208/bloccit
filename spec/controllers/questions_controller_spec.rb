...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe "GET #edit" do
    ...
    it "assigns question to be updated to @question" do
      ...
      expect(question_instance.resolved).to be(true).or be(false)
    end  
  end
  ...
  describe "PUT update" do
    it "updates question with expected attributes" do
      ...
      put :update, params: {question: { id: my_question.id, title: new_title, body: new_body, resolved: false }} 
    ...
    it "redirects to the updated question" do
      ...
      put :update, params: {question: { id: my_question.id, title: new_title, body: new_body, resolved: true }}  
